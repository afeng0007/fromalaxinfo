...
#define REGISTRY_PRODUCTROOT	_T("SOFTWARE\\Alax.Info\\Utilities\\MaxMind GeoLite Tools")
#define REGISTRY_FILEROOT		REGISTRY_PRODUCTROOT
#define REGISTRY_ROOT			REGISTRY_FILEROOT

//#define WRAP_MEDIASAMPLE_WITH_MEDIASAMPLE2 // Adobe Flash Media Live Encoder 3.1 Compatibility
