========================================================================
    ACTIVE TEMPLATE LIBRARY : WrapText Project Overview
========================================================================

AppWizard has created this WrapText project for you to use as the starting point for
...
WrapText.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (WrapText.h)
        GUID definitions                                (WrapText_i.c)
        A type library                                  (WrapText.tlb)
        Marshaling code                                 (WrapText_p.c and dlldata.c)

WrapText.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in WrapText.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named WrapText.pch and a precompiled types file named StdAfx.obj.
...
WrapTextps.vcxproj
	...
	dlldata.c, WrapText_i.c and WrapText_p.c which are required
	to build the proxy/stub DLL.

WrapTextps.vcxproj.filters
