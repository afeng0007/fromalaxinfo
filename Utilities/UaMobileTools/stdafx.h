...
// NOTE: This is required to correctly convert ANSI Russian to Unicode Russian, to match hardcoded constants
...
#define REGISTRY_PRODUCTROOT	_T("SOFTWARE\\Alax.Info\\Utilities\\UaMobileTools")
