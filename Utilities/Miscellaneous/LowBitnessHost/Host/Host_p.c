...
typedef struct _Host_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } Host_MIDL_TYPE_FORMAT_STRING;

typedef struct _Host_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } Host_MIDL_PROC_FORMAT_STRING;

typedef struct _Host_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } Host_MIDL_EXPR_FORMAT_STRING;
...
extern const Host_MIDL_TYPE_FORMAT_STRING Host__MIDL_TypeFormatString;
extern const Host_MIDL_PROC_FORMAT_STRING Host__MIDL_ProcFormatString;
extern const Host_MIDL_EXPR_FORMAT_STRING Host__MIDL_ExprFormatString;
...
static const Host_MIDL_PROC_FORMAT_STRING Host__MIDL_ProcFormatString =
    {
        0,
        {
...
static const Host_MIDL_TYPE_FORMAT_STRING Host__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IFoo, ver. 0.0,
   GUID={0xD22A348B,0x2542,0x4618,{0xAD,0x41,0x00,0xEE,0x1E,0xDB,0xAF,0xB7}} */
...
static const MIDL_STUBLESS_PROXY_INFO IFoo_ProxyInfo =
    {
    &Object_StubDesc,
    Host__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    Host__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _Host_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFooProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _Host_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFooStubVtbl,
    0
};
...
const IID *  const _Host_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
