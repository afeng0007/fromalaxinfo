...
typedef struct _Library_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } Library_MIDL_TYPE_FORMAT_STRING;

typedef struct _Library_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } Library_MIDL_PROC_FORMAT_STRING;

typedef struct _Library_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } Library_MIDL_EXPR_FORMAT_STRING;
...
extern const Library_MIDL_TYPE_FORMAT_STRING Library__MIDL_TypeFormatString;
extern const Library_MIDL_PROC_FORMAT_STRING Library__MIDL_ProcFormatString;
extern const Library_MIDL_EXPR_FORMAT_STRING Library__MIDL_ExprFormatString;
...
static const Library_MIDL_PROC_FORMAT_STRING Library__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 64 */	NdrFcShort( 0x1b ),	/* Flags:  must size, must free, in, out, */
...
static const Library_MIDL_TYPE_FORMAT_STRING Library__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IFoo, ver. 0.0,
   GUID={0x955C1132,0x96DC,0x4221,{0x86,0xA3,0xBE,0x4C,0x8C,0xEB,0x69,0x8C}} */
...
static const MIDL_STUBLESS_PROXY_INFO IFoo_ProxyInfo =
    {
    &Object_StubDesc,
    Library__MIDL_ProcFormatString.Format,
...
static const MIDL_SERVER_INFO IFoo_ServerInfo = 
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(9) _IFooProxyVtbl = 
{
    &IFoo_ProxyInfo,
    &IID_IFoo,
    ...
    (void *) (INT_PTR) -1 /* IFoo::Bar1 */ ,
    (void *) (INT_PTR) -1 /* IFoo::Bar2 */
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    Library__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _Library_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFooProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _Library_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFooStubVtbl,
    0
};
...
const IID *  const _Library_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
const ExtendedProxyFileInfo Library_ProxyFileInfo = 
{
    ...
    (const IID ** ) & _Library_BaseIIDList,
    & _Library_IID_Lookup, 
    1,
    2,
