 ...
 * Local Time: `12/15/2013 3:06:02 PM`
 * Architecture: x86
...
## API Information
  ...
  * 64-Bit Integer `BMDDeckLinkAPIVersion`: `151390208` (`0x9060800`)
 ...
 * Attributes:
  ...
  * Flag (32-Bit Integer) `BMDDeckLinkDeviceIsPlaybackOnly`: `0` (`0x0`)
  * Flag (32-Bit Integer) `BMDDeckLinkDeviceIsCaptureOnly`: `0` (`0x0`)
