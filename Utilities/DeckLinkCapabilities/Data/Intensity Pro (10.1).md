 ...
 * Computer Name: `PC-MDZIEW-3`
 * User Name: `Labuser` (Administrator)
 * Local Time: `3/12/2015 9:25:53 AM`
 * Architecture: AMD/Intel x64 (x64 Application)
 * Processors: `8`, Active Mask `0xFF`
 * Page Size: `0x1000`
 * Application Address Space: `0x0000000000010000`..`0x000007FFFFFEFFFF`
 * Physical Memory: `3,890` MB
 * Committed Memory Limit: `7,779` MB

# DeckLink API

## API Information

  * 64-Bit Integer `BMDDeckLinkAPIVersion`: `167837696` (`0xA010000`)
