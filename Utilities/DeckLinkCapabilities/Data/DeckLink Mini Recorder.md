 ...
 * Computer Name: `34MC025`
 * User Name: `OPUSER` 
 * Local Time: `31.03.2014 14:43:53`
 * Architecture: x86
 * Processors: `4`, Active Mask `0xF`
 * Page Size: `0x1000`
 * Application Address Space: `0x00010000`..`0x7FFEFFFF`
 * Physical Memory: `3.427` MB
 * Committed Memory Limit: `6.852` MB

# DeckLink API

## API Information

  * 64-Bit Integer `BMDDeckLinkAPIVersion`: `167772160` (`0xA000000`)
