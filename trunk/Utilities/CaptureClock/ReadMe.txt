========================================================================
    ACTIVE TEMPLATE LIBRARY : CaptureClock Project Overview
========================================================================

AppWizard has created this CaptureClock project for you to use as the starting point for
writing your Executable (EXE).

This file contains a summary of what you will find in each of the files that
make up your project.

CaptureClock.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

CaptureClock.vcxproj.filters
...
CaptureClock.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (CaptureClock.h)
        GUID definitions                                (CaptureClock_i.c)
        A type library                                  (CaptureClock.tlb)
        Marshaling code                                 (CaptureClock_p.c and dlldata.c)

CaptureClock.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in CaptureClock.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named CaptureClock.pch and a precompiled types file named StdAfx.obj.
...
CaptureClockps.vcxproj
	...
	dlldata.c, CaptureClock_i.c and CaptureClock_p.c which are required
	to build the proxy/stub DLL.

CaptureClockps.vcxproj.filters
