...
#include "stdafx.h"
#include "resource.h"
#include "WrapText_i.h"
#include "MainDialog.h"

////////////////////////////////////////////////////////////
// CWrapTextModule

class CWrapTextModule : 
	public CAtlExeModuleT<CWrapTextModule>,
	public CWtlExeModuleT<CWrapTextModule>
{
public:

//DECLARE_LIBID(LIBID_AlaxInfoWrapText)

//DECLARE_REGISTRY_APPID_RESOURCEID(IDR_MODULE, "{0B0FCF8F-E12E-4E97-B683-06E3F93830E3}")

public:
// CWrapTextModule
	CWrapTextModule() throw()
	{
#if defined(_DEBUG)
