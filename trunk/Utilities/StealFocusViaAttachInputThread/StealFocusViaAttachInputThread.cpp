...
#include "stdafx.h"
#include "resource.h"
#include "StealFocusViaAttachInputThread_i.h"
#include "MainDialog.h"

////////////////////////////////////////////////////////////
// CStealFocusViaAttachInputThreadModule

class CStealFocusViaAttachInputThreadModule : 
	public CAtlExeModuleT<CStealFocusViaAttachInputThreadModule>,
	public CWtlExeModuleT<CStealFocusViaAttachInputThreadModule>
{
public:

//DECLARE_LIBID(LIBID_AlaxInfoStealFocusViaAttachInputThread)

//DECLARE_REGISTRY_APPID_RESOURCEID(IDR_MODULE, "{0B0FCF8F-E12E-4E97-B683-06E3F93830E3}")

public:
// CStealFocusViaAttachInputThreadModule
	CStealFocusViaAttachInputThreadModule() throw()
	{
		#if defined(_DEBUG)
...
CStealFocusViaAttachInputThreadModule _AtlModule;
