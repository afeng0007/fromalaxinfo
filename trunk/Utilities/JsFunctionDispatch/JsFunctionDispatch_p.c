...
typedef struct _JsFunctionDispatch_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } JsFunctionDispatch_MIDL_TYPE_FORMAT_STRING;

typedef struct _JsFunctionDispatch_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } JsFunctionDispatch_MIDL_PROC_FORMAT_STRING;

typedef struct _JsFunctionDispatch_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } JsFunctionDispatch_MIDL_EXPR_FORMAT_STRING;
...
extern const JsFunctionDispatch_MIDL_TYPE_FORMAT_STRING JsFunctionDispatch__MIDL_TypeFormatString;
extern const JsFunctionDispatch_MIDL_PROC_FORMAT_STRING JsFunctionDispatch__MIDL_ProcFormatString;
extern const JsFunctionDispatch_MIDL_EXPR_FORMAT_STRING JsFunctionDispatch__MIDL_ExprFormatString;
...
static const JsFunctionDispatch_MIDL_PROC_FORMAT_STRING JsFunctionDispatch__MIDL_ProcFormatString =
    {
        0,
        {
...
static const JsFunctionDispatch_MIDL_TYPE_FORMAT_STRING JsFunctionDispatch__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IFoo_ProxyInfo =
    {
    &Object_StubDesc,
    JsFunctionDispatch__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    JsFunctionDispatch__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _JsFunctionDispatch_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFooProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _JsFunctionDispatch_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFooStubVtbl,
    0
};

PCInterfaceName const _JsFunctionDispatch_InterfaceNamesList[] = 
{
    "IFoo",
    0
};

const IID *  const _JsFunctionDispatch_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _JsFunctionDispatch_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _JsFunctionDispatch, pIID, n)

int __stdcall _JsFunctionDispatch_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_JsFunctionDispatch_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo JsFunctionDispatch_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _JsFunctionDispatch_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _JsFunctionDispatch_StubVtblList,
    (const PCInterfaceName * ) & _JsFunctionDispatch_InterfaceNamesList,
    (const IID ** ) & _JsFunctionDispatch_BaseIIDList,
    & _JsFunctionDispatch_IID_Lookup, 
    1,
    2,
