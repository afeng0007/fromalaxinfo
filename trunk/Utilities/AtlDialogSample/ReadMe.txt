========================================================================
    ACTIVE TEMPLATE LIBRARY : AtlDialogSample Project Overview
========================================================================

AppWizard has created this AtlDialogSample project for you to use as the starting point for
writing your Executable (EXE).

This file contains a summary of what you will find in each of the files that
make up your project.

AtlDialogSample.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

AtlDialogSample.vcxproj.filters
...
AtlDialogSample.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (AtlDialogSample.h)
        GUID definitions                                (AtlDialogSample_i.c)
        A type library                                  (AtlDialogSample.tlb)
        Marshaling code                                 (AtlDialogSample_p.c and dlldata.c)

AtlDialogSample.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in AtlDialogSample.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named AtlDialogSample.pch and a precompiled types file named StdAfx.obj.
...
AtlDialogSampleps.vcxproj
	...
	dlldata.c, AtlDialogSample_i.c and AtlDialogSample_p.c which are required
	to build the proxy/stub DLL.

AtlDialogSampleps.vcxproj.filters
