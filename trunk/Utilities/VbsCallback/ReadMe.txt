========================================================================
    ACTIVE TEMPLATE LIBRARY : VbsCallback Project Overview
========================================================================

AppWizard has created this VbsCallback project for you to use as the starting point for
...
VbsCallback.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (VbsCallback.h)
        GUID definitions                                (VbsCallback_i.c)
        A type library                                  (VbsCallback.tlb)
        Marshaling code                                 (VbsCallback_p.c and dlldata.c)

VbsCallback.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in VbsCallback.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named VbsCallback.pch and a precompiled types file named StdAfx.obj.
...
VbsCallbackps.vcxproj
	...
	dlldata.c, VbsCallback_i.c and VbsCallback_p.c which are required
	to build the proxy/stub DLL.

VbsCallbackps.vcxproj.filters
