========================================================================
    ACTIVE TEMPLATE LIBRARY : MaxMindGeoLite Project Overview
========================================================================

AppWizard has created this MaxMindGeoLite project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

MaxMindGeoLite.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

MaxMindGeoLite.vcxproj.filters
...
MaxMindGeoLite.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (MaxMindGeoLite.h)
        GUID definitions                                (MaxMindGeoLite_i.c)
        A type library                                  (MaxMindGeoLite.tlb)
        Marshaling code                                 (MaxMindGeoLite_p.c and dlldata.c)

MaxMindGeoLite.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in MaxMindGeoLite.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named MaxMindGeoLite.pch and a precompiled types file named StdAfx.obj.
...
MaxMindGeoLiteps.vcxproj
	...
	dlldata.c, MaxMindGeoLite_i.c and MaxMindGeoLite_p.c which are required
	to build the proxy/stub DLL.

MaxMindGeoLiteps.vcxproj.filters
