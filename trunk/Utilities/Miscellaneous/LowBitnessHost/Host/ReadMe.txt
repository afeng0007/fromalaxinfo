========================================================================
    ACTIVE TEMPLATE LIBRARY : Host Project Overview
========================================================================

AppWizard has created this Host project for you to use as the starting point for
...
Host.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Host.h)
        GUID definitions                                (Host_i.c)
        A type library                                  (Host.tlb)
        Marshaling code                                 (Host_p.c and dlldata.c)

Host.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Host.idl. It will be regenerated by MIDL during compilation.
...
Hostps.vcxproj
	...
	dlldata.c, Host_i.c and Host_p.c which are required
	to build the proxy/stub DLL.

Hostps.vcxproj.filters
