========================================================================
    ACTIVE TEMPLATE LIBRARY : StressEvr Project Overview
========================================================================

AppWizard has created this StressEvr project for you to use as the starting point for
...
StressEvr.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (StressEvr.h)
        GUID definitions                                (StressEvr_i.c)
        A type library                                  (StressEvr.tlb)
        Marshaling code                                 (StressEvr_p.c and dlldata.c)

StressEvr.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in StressEvr.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named StressEvr.pch and a precompiled types file named StdAfx.obj.
...
StressEvrps.vcxproj
	...
	dlldata.c, StressEvr_i.c and StressEvr_p.c which are required
	to build the proxy/stub DLL.

StressEvrps.vcxproj.filters
